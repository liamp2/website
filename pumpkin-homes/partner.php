...
<body>
    ...
    <section id="investors">
        <div class="container my-3">
            <div class="row">
                <h2 class="text-center text-primary">Investors</h2>
                <hr class="hr-green">
    ...
    <!-- REALATORS -->
    <section class="bg-light" id="relators">
        <div class="container py-3">
            <div class="row">
                <h2 class="text-center text-success">Realators</h2>
    ...
    <section id="brokers">
        <div class="container py-3">
            <div class="row">
                <h2 class="text-center text-primary">Mortgage Brokers</h2>
                <hr class="hr-green">
                <div class="col-lg-7">
                    <p class="text-center">
